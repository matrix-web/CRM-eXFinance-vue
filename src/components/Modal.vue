<template>
  <div class="modal-wrap" ref="modal" @click="close" :aria-hidden="[isOpen ? true : false]" :class="[isOpen ? 'open' : 'close']">
    <div class="modal-overlay" data-close="true">
      <div class="modal-window" ref="modal" role="dialog" aria-modal="true">
        ...
        <footer class="modal-footer">
          <button :class="buttonClassAction" @click="$emit('modal-action')">Удалить</button>
